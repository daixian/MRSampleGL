...
#include <GL/gl.h>
#include "ViewGL.h"
#include "../Base/Controller.h"         // for dummy GL window , 在findPixelFormatWithAttributes()函数中使用
#include "../Base/Window.h"             // for dummy window

#include "../GL/glext.h"
#include "../GL/wglext.h"             // for wgl extensions after glext.h
#include "../GL/glExtension.h"
